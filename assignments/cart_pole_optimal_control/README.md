...
˙
​
  is the cart's velocity.
𝜃
θ is the pole's angle from the vertical.
𝜃
˙
θ
˙
  is the pole's angular velocity.
The control input 
𝑢
u is the force applied to the cart, which directly affects system dynamics.
...
Increased penalty on cart position (
𝑄
11
=
100.0
...
11
​
 =100.0) → Forces the cart to remain near its reference position.
Higher weight on pole angle (
𝑄
33
=
100.0
...
33
​
 =100.0) → Stronger correction to keep the pole upright.
Moderate weight on cart velocity (
𝑄
22
=
50.0
...
22
​
 =50.0) → Ensures smooth motion without excessive control effort.
Pole angular velocity weight kept lower (
𝑄
44
=
10.0
...
44
​
 =10.0) → Reduces unnecessary oscillations.
